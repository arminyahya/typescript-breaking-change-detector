    ...
    for (const declarationInPrevCode of prevCode.body) {
      switch (declarationInPrevCode.type as keyof typeof AST_NODE_TYPES) {
        ...
        case AST_NODE_TYPES.TSPropertySignature:
          checkAndThrowError(propertyValidator(context, declarationInPrevCode, currentCode));
          break;
        case AST_NODE_TYPES.FunctionDeclaration:
          checkAndThrowError(tsDeclareFunctionValidator(context, declarationInPrevCode, currentCode));
          break;
